...
export default function About() {
  ...
  const aboutContent = {
    en: {
      ...
      cyberText:
        "Microverse - digital realm for game creators. Build, share, play in neon matrix.",
    ...
    ru: {
      ...
      cyberText:
        "Microverse - цифровое пространство для создателей игр. Создавай, делись, играй в неоновой матрице.",
        ...
        <div className="space-y-8 mb-12">
          <div className="bg-black/60 rounded-xl p-8 border border-cyan-400/30">
            <h2 className="text-2xl font-bold text-pink-400 mb-4">
              {current.cyberPlatform}
            </h2>
            <p className="text-gray-300 leading-relaxed">{current.cyberText}</p>
          </div>
          ...
          <div className="bg-black/60 rounded-xl p-8 border border-pink-400/30">
            ...
            <p className="text-gray-300 leading-relaxed">{current.techText}</p>
          </div>
          ...
          <div className="bg-black/60 rounded-xl p-8 border border-yellow-400/30">
            ...
            <p className="text-gray-300 leading-relaxed">{current.joinText}</p>
          </div>
        </div>

        {/* Соцсети */}
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-green-400 mb-6 text-center tracking-wide">
            {current.digitalConnections}
          </h3>
          <SocialLinks />
        </div>
